...
local inline = {{{text="⚜│قنآهہ‏‏ آلسـورس Tweakjailbreak  ",url="t.me/tweakjailbreak"}}}
...
elseif Text== "مصطفى" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/alone_kurdish")
