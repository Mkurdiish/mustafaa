...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
redis:setex(max..'rulse:witting'..msg.chat_id_,300,true)
...
if not msg.Creator then return "♦️*│*هذا الامر يخص {المطور,المنشئ} فقط  \n💥" end
redis:setex(max..'about:witting'..msg.chat_id_..msg.sender_user_id_,300,true) 
...
redis:setex(max..'welcom_ph:witting'..msg.chat_id_..msg.sender_user_id_,300,true) 
...
redis:setex(max..'text_sudo:witting'..msg.chat_id_..msg.sender_user_id_,1200,true) 
...
return '👨🏾‍🔧│ اصدار سورس مصطفى : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس 🔂') then
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https.request('https://github.com/Mkurdiish/mustafaa.github.io/GetVersion.txt') or 0
...
sendMsg(msg.chat_id_,msg.id_,'📛*│* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس مصطفى يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n💥')
end  
else
...
local inline = {{{text="⚜│قنآهہ‏‏ آلسـورس ❤️  ",url="t.me/tweakjailbreak"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : مصطفى](t.me/@tweakjailbreak)',nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
redis:setex(max..'namebot:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
...
return [[
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉     
👨🏻‍✈️╽[مطور السـورس](t.me/alone_kurdish)
📡╿[قناة السورس](t.me/tweakjailbreak)
...
elseif Text== " مصطفى كردش" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/alone_kurdish")
elseif Text== "مصطفى كردي " then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس مصطفى 😍](t.me/Hskh56")
...
👨🏽‍⚖️│بالتـوفيـق عزيزي ...
🎁╽[اضغط هنا لديك مفاجئه](tweakjailbreak)
]] )
--=====================================
