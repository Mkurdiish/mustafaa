...
function tdcli_update_callback(data)
	...
	download_file('https://github.com/Mkurdiish/mustafa','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://github.com/Mkurdiish/mustafa','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://github.com/Mkurdiish/mustafa','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://github.com/Mkurdiish/mustafa.lua','./inc/functions.lua')
	download_file('https://github.com/Mkurdiish/mustafa.lua','./plugins/zhrfa.lua')
	download_file('https://github.com/Mkurdiish/mustafa.lua','./plugins/games.lua')
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	download_file('https://github.com/Mkurdiish/mustafa','./inc/locks.lua')
	download_file('https://github.com/Mkurdiish/mustafa.lua','./plugins/zhrfa.lua')
	download_file('https://github.com/Mkurdiish/mustafa')
